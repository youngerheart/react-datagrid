...
module.exports = function (keys, data) {
    ...
    if (groupData) {
        ...
        var getDeepData = (function (_getDeepData) {
            function getDeepData(_x, _x2) {
                return _getDeepData.apply(this, arguments);
            }

            getDeepData.toString = function () {
                return _getDeepData.toString();
            };

            return getDeepData;
        })(function (group, resultArray) {
            var data = group.data;
            var keys = group.keys;
